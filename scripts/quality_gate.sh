...
while IFS= read -r -d '' file; do
    ...
    case "$file" in
        ./.node_modules/*|./.git/*|./dist/*|./coverage/*|./docs/*|./reports/*|./tests/*|./.agents/*|./.claude/*|./.opencode/*|./plans/*|./public/*|node_modules/*|.git/*|dist/*|coverage/*|docs/*|reports/*|tests/*|.agents/*|.claude/*|.opencode/*|plans/*|public/*) continue ;;
    esac
