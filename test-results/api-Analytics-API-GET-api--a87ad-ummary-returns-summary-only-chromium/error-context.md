...
- Name: api.spec.ts >> Analytics API >> GET /api/analytics?format=summary returns summary only
- Location: tests/e2e/api.spec.ts:162:3
...
Received value: {"avgDealsPerDay": 0, "expiringNext7Days": 0, "lastUpdated": "2026-03-31T19:20:00Z", "topCategory": "welcome", "topSource": "example.com", "totalActiveDeals": 1, "totalDealsDiscovered": 0, "totalDealsPublished": 0}
```
