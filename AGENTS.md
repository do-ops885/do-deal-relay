...
**Version**: 0.2.3 (Adapted Upstream Workflow Standards v0.3.5)

## 1. Named Constants & System Hot Files
```bash
...
3. **Infer Conventions**: Align with existing patterns (Centralized Middleware Router, SQLite tables, strict TypeScript, and Durable Objects) instead of generic template styles.
