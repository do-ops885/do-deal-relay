...
You may optionally route subtasks to the **web-search-researcher** or **general-purpose** agent when external, factual, or real-time research is required.  
...
- Use **web-search-researcher** or **general-purpose** as the research agent when needed  
...
## 3. Research Routing via web-search-researcher
Invoke **only when**:
...
- Use **web-search-researcher** for research subtasks before planning or execution  
...
4. If unknowns block planning → assign a subtask to **web-search-researcher**  
...
1. Identify unknowns  
2. Delegate research to **web-search-researcher**  
