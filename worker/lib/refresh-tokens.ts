 ...
 *
 * @param env - Worker environment
 * @param oldTokenId - ID of the token being rotated out
 * @param newTokenHash - Hash of the newly issued refresh token
 * @param newTokenId - ID of the newly created refresh token record
 * @returns Promise resolving when old token record is marked as replaced
 */
 ...
 *
 * @param env - Worker environment
 * @param family - Family ID whose tokens should be revoked
 ...
 *
 * @param env - Worker environment
 * @param userId - User ID whose active tokens should be revoked
 * @returns Promise resolving to the total count of tokens revoked
 */
 ...
 *
 * @param env - Worker environment
 * @param userId - User ID whose active tokens should be counted
 * @returns Promise resolving to the number of active refresh tokens
 */
