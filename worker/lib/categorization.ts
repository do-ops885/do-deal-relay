...
export const CATEGORY_DEFINITIONS: Record<string, {
  keywords: string[];
  domains: string[];
  description: string;
}> = {
  finance: {
    keywords: [
      "bank", "investing", "brokerage", "trading", "stock", "crypto",
      "credit card", "debit card", "loan", "mortgage", "savings",
      "checking", "account", "cashback", "dividend", "portfolio",
      "trade", "deposit", "withdrawal", "transfer", "dividend"
    ],
    domains: [
      "trading212.com", "robinhood.com", "webull.com", "public.com",
      "moomoo.com", "fidelity.com", "schwab.com", "etrade.com",
      "coinbase.com", "binance.com", "kraken.com", "gemini.com",
      "chase.com", "bankofamerica.com", "wellsfargo.com", "citi.com",
      "americanexpress.com", "capitalone.com", "discover.com"
    ],
    description: "Financial services, banking, investing, and trading platforms"
  },

  food_delivery: {
    keywords: [
      "food", "delivery", "meal", "restaurant", "dining", "grocery",
      "doordash", "ubereats", "grubhub", "postmates", "delivery",
      "takeout", "cuisine", "pizza", "sushi", "burger"
    ],
    domains: [
      "doordash.com", "ubereats.com", "grubhub.com", "postmates.com",
      "instacart.com", "gopuff.com", "delivery.com", "seamless.com"
    ],
  ...
  transportation: {
    keywords: [
      "ride", "taxi", "uber", "lyft", "transport", "travel", "commute",
      "scooter", "bike", "rental", "car", "vehicle", "mile", "trip"
    ],
    domains: [
      "uber.com", "lyft.com", "lime.bike", "bird.co", "spin.app",
      "zipcar.com", "turo.com", "getaround.com"
    ],
  ...
  travel: {
    keywords: [
      "hotel", "flight", "airbnb", "booking", "vacation", "trip",
      "travel", "stay", "accommodation", "airline", "resort",
      "expedia", "booking.com", "hostel", "motel"
    ],
    domains: [
      "airbnb.com", "booking.com", "expedia.com", "hotels.com",
      "kayak.com", "priceline.com", "trip.com", "agoda.com",
      "vrbo.com", "hostelworld.com", "skyscanner.com"
    ],
  ...
  shopping: {
    keywords: [
      "shop", "store", "discount", "coupon", "cashback", "save",
      "amazon", "ebay", "retail", "purchase", "buy", "sale",
      "deal", "offer", "promo", "voucher"
    ],
    domains: [
      "amazon.com", "ebay.com", "walmart.com", "target.com",
      "bestbuy.com", "costco.com", "rakuten.com", "retailmenot.com",
      "honey.com", "ibotta.com", "fetchrewards.com"
    ],
  ...
  cloud_storage: {
    keywords: [
      "cloud", "storage", "backup", "sync", "file", "data",
      "google drive", "dropbox", "onedrive", "icloud", "server",
      "hosting", "vps", "database", "cdn"
    ],
    domains: [
      "dropbox.com", "drive.google.com", "icloud.com", "onedrive.live.com",
      "box.com", "pcloud.com", "sync.com", "mega.nz",
  ...
  communication: {
    keywords: [
      "phone", "mobile", "cell", "internet", "wifi", "broadband",
      "verizon", "at&t", "t-mobile", "sprint", "mint", "visible",
      "call", "text", "message", "chat", "voip"
    ],
    domains: [
      "verizon.com", "att.com", "t-mobile.com", "mintmobile.com",
      "visible.com", "cricketwireless.com", "metrobyt-mobile.com",
      "uscellular.com", "xfinity.com", "spectrum.com"
    ],
    description: "Mobile carriers, internet providers, and communication services"
  },

  entertainment: {
    keywords: [
      "streaming", "movie", "music", "video", "game", "gaming",
      "netflix", "spotify", "hulu", "disney", "hbo", "prime",
      "subscription", "watch", "listen", "play", "console"
    ],
    domains: [
      "netflix.com", "spotify.com", "hulu.com", "disneyplus.com",
      "hbomax.com", "primevideo.com", "youtube.com", "twitch.tv",
      "steam.com", "xbox.com", "playstation.com", "epicgames.com"
    ],
  ...
  health: {
    keywords: [
      "health", "fitness", "gym", "workout", "exercise", "wellness",
      "medical", "doctor", "pharmacy", "insurance", "vitamin",
      "peloton", "nike", "adidas", "under armour"
    ],
    domains: [
      "peloton.com", "nike.com", "adidas.com", "underarmour.com",
      "myfitnesspal.com", "strava.com", "fitbit.com", "whoop.com",
      "headspace.com", "calm.com", "noom.com", "weightwatchers.com"
    ],
  ...
  education: {
    keywords: [
      "learn", "course", "class", "education", "study", "student",
    ...
    domains: [
      ...
      "edx.org", "khanacademy.org", "duolingo.com", "codecademy.com",
  ...
  software: {
    keywords: [
      "software", "app", "application", "tool", "saas", "license",
      "subscription", "download", "install", "program", "service"
    ],
    domains: [
      "github.com", "gitlab.com", "notion.so", "slack.com", "zoom.us",
      "figma.com", "canva.com", "adobe.com", "microsoft.com"
    ],
  ...
  referral: {
    keywords: [
      "refer", "referral", "invite", "friend", "sign up", "join",
      "new user", "first time", "bonus", "reward", "credit"
    ],
    domains: [],
...
export const TAG_DEFINITIONS: Record<string, {
  keywords: string[];
  relatedCategories: string[];
}> = {
  signup_bonus: {
    keywords: ["sign up", "new account", "first deposit", "welcome bonus", "new user"],
  ...
  crypto: {
    keywords: ["bitcoin", "ethereum", "crypto", "cryptocurrency", "btc", "eth", "wallet"],
  ...
  recurring: {
    keywords: ["monthly", "annual", "subscription", "recurring", "per month", "per year"],
    relatedCategories: []
  }
};
...
export function calculateCategoryScores(deal: Deal): Map<string, number> {
  ...
  const text = `${deal.title} ${deal.description} ${deal.source.domain}`.toLowerCase();
  ...
  for (const [category, definition] of Object.entries(CATEGORY_DEFINITIONS)) {
    ...
    if (definition.domains.some(d => deal.source.domain.toLowerCase().includes(d))) {
      score += 10;
    }
...
export function calculateTagScores(deal: Deal): Map<string, number> {
  ...
  const rewardValue = typeof deal.reward.value === "number" ? deal.reward.value : 0;
  if (rewardValue >= 50) {
