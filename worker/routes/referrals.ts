...
import { ReferralInputSchema, ReferralSearchQuerySchema } from "../types";
import {
  storeReferralInput,
  getReferralByCode,
  searchReferrals,
...
// Lifecycle handlers (deactivate/reactivate) extracted to
// referrals-lifecycle.ts; re-exported so importers are unchanged.
export {
  handleDeactivateReferral,
  handleReactivateReferral,
} from "./referrals-lifecycle";
