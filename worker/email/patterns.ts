...
// 20+ services with accurate patterns for referral code extraction
// ============================================================================
...
export const GENERIC_PATTERNS = {
  ...
  // URL patterns for referral links - CRITICAL: These extract complete URLs
  referralUrlPatterns: [
    // Standard referral paths
  ...
  codePatterns: [
    ...
    /(?:code|einladung)\s*[:\-]?\s*["']?([A-Z0-9]{6,})/i, // German support
  ],
