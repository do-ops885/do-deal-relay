...
import { deduplicate, calculateSourceDiversity, calculateUniquenessScore } from '../worker/pipeline/dedupe';
...
const createMockDeal = (id: string, overrides: Partial<Deal> = {}): Deal => ({
  ...
  url: `https://${overrides.source?.domain || 'example.com'}/invite/CODE123`,
  reward: {
    type: 'cash',
    value: 50,
    currency: 'USD'
